...
class ActionDoneEvent : public ConnectionEvent {
  ActionDoneEvent(void *cont): ConnectionEvent("All commands completed"), content(cont) {};
...
class ConnectionEstablishedEvent: public ConnectionEvent {
  ConnectionEstablishedEvent: ConnectionEvent("connection established successfully") {}
